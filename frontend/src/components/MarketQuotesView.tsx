...
export const MarketQuotesView: React.FC<MarketQuotesViewProps> = ({ wsConnected }) => {
  ...
  return (
    <div id="market-quotes-view" className="flex flex-col lg:flex-row gap-3 xl:gap-4 py-0 min-h-0">

      {/* LEFT PANEL — MASTER (LIST) */}
      <div className={`flex flex-col gap-4 min-w-0 ${selectedSymbol ? 'lg:w-1/2' : 'w-full'} transition-all duration-300`}>

        {/* HEADER */}
        <div className="glass-card rounded-2xl p-4 xl:p-5 flex flex-col md:flex-row md:items-center justify-between gap-3">
          <div>
        ...
        {/* LIST */}
        <div className="glass-card rounded-2xl p-4 xl:p-5">
            ...
            {pageRecords.map((rec, index) => {
              ...
              return (
                <div
                  ...
                  className={`p-3 xl:p-4 rounded-xl border transition-all duration-200 cursor-pointer flex flex-col md:flex-row md:items-center justify-between gap-3 ${
                    isSelected
      ...
      {selectedSymbol && (
        <div className="lg:w-1/2 flex flex-col gap-3 min-w-0">
          ...
          {/* DETAIL HEADER */}
          <div className="glass-card rounded-2xl p-4 xl:p-5 flex items-center justify-between gap-3 sticky top-0 z-10 backdrop-blur-md">
