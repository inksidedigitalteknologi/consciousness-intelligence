...
export const BrainView: React.FC<BrainViewProps> = ({
  ...
  return (
    <div id="brain-view" className="space-y-5 pb-12">
      ...
      {/* META PANEL */}
      {meta && (
        <div className="grid grid-cols-2 md:grid-cols-5 xl:grid-cols-7 2xl:grid-cols-10 gap-2.5">
      ...
      {/* PIPELINE + REFLECTION */}
      <div className="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-5">
        {/* PIPELINE */}
          ...
          {activeTab === 'developer' && (
            <div className="space-y-4">
              ...
              <div>
                ...
                {metrics ? (
                  <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-6 2xl:grid-cols-8 gap-2.5">
      ...
      <div className="p-4 rounded-2xl bg-[#131A22] border border-[#26313D]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 2xl:grid-cols-10 gap-2 mt-3">
