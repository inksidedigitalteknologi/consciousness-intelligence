...
const DividendHunterSection: React.FC<{
  ...
  return (
    <div className="p-5 rounded-2xl bg-[#131A22] border border-[#26313D] shadow-lg">
      ...
      {/* Stats */}
      <div className="grid grid-cols-2 md:grid-cols-5 xl:grid-cols-7 2xl:grid-cols-10 gap-3 mt-4">
    ...
    <DashboardErrorBoundary>
      <div id="dashboard-view" className="space-y-6 pb-12">
        ...
        <div className="p-5 rounded-2xl bg-[#131A22] border border-[#26313D] shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 2xl:grid-cols-8 gap-3.5 mt-4">
            {signals.length === 0 ? (
